...
export default function LoginCard() {
  return (
    <div id="login-card" className="flex flex-col md:flex-row md:h-150 w-full max-w-4xl bg-white rounded-2xl shadow-xl overflow-hidden h-auto font-poppins">
      ...
      <div id="left-side" className="flex flex-col w-full md:w-1/2 p-6 sm:p-10 justify-center">
        <div id="login-title" className="text-center">
          <h3 className="text-2xl  mb-4 font-bold">LOGIN</h3>
